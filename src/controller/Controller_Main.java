...
public class Controller_Main implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		tc_shoppingcart_nr.setCellValueFactory(new PropertyValueFactory<Product, Integer>("number"));
		...
		tc_shoppingcart_price.setCellValueFactory(new PropertyValueFactory<Product, Double>("price"));
